...
def run_experiment(
    ...
    training_config.prover_trainer_cls = "WeightedTrainer"
    ...
    pipeline_config = PipelineConfig(
        ...
        freeze_prover=False,
        statement_selection_mode=StatementSelectionMode.LESS_16_PROOFS,
    )
...
if __name__ == "__main__":
    ...
    for lr in lrs:
        checkpoint_dir = f"./checkpoints/ei_solver_only/lr_{lr}"
