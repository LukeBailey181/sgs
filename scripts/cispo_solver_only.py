...
def run_experiment(
    ...
    conjecturer_config = get_deepseek_prover_v2_conjecturer_config(ConjecturerSetup.TARGET_STATEMENT)
...
if __name__ == "__main__":
    ...
    run_local = True
    for lr in lrs:
        checkpoint_dir = f"./checkpoints/cispo_solver_only/lr_{lr}"
