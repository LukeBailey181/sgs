...
from sgs.utils.prompts import (
    get_deepseek_prover_v2_conjecturer_no_grounding_prompt,
)
...
def run_experiment(
    ...
    conjecturer_config.prompt_getter = get_deepseek_prover_v2_conjecturer_no_grounding_prompt
...
if __name__ == "__main__":
    ...
    for lr in lrs:
        checkpoint_dir = f"./checkpoints/sgs_no_problem_conditioning/lr_{lr}"
