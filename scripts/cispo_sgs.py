...
from sgs.pipeline.config import PipelineConfig, StatementSelectionMode
from sgs.models.model_types import ConjecturerSetup
from sgs.models.guide import GuideConfig
from sgs.pipeline.full_pipeline import run_pipeline, RunPipelineCheckpointable
from sgs.models.guide.llm_judge_guide import DeepseekProverV2LemmaGuideLocal
...
def run_experiment(
    ...
    conjecturer_config = get_deepseek_prover_v2_conjecturer_config(ConjecturerSetup.TARGET_STATEMENT_ONLY_UNSOLVED)

    # Some reward shaping things
    ...
    pipeline_config = PipelineConfig(
        ...
        num_master_verification_workers=100,
        ...
        freeze_prover=False,
        statement_selection_mode=StatementSelectionMode.ALL_NONE_0_1,
    )
...
if __name__ == "__main__":
    ...
    run_local = True
    for lr in lrs:
        checkpoint_dir = f"./checkpoints/cispo_sgs/lr_{lr}"
